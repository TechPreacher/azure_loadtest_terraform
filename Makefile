...
clean_script: ## Cleans the script generated by Terraform
	rm -rf terraform/load_test_config.json terraform/setup_load_test.sh
	@echo "Cleaned up Terraform state files and directories."
