...
resource "null_resource" "manual_steps_reminder" {
  provisioner "local-exec" {
    command = <<-EOT
      ...
      echo "1. load_test_variables.env - Environment variables for your setup script"
      echo "2. load_test_config.json - JSON configuration for Azure Load Test API"
      echo "3. LOAD_TEST_README.md - Instructions for using these files"
      echo ""
      echo "To use with your existing setup script:"
      echo "  1. At the beginning of your script, add: source ./load_test_variables.env"
